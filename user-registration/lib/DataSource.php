 ...
 *
 *
 * Configuration to coonect the database to the login form and registration form
 *
 *
 */
namespace Php;
 ...
 * Uses MySql and PreparedStatements.
 *
...
class DataSource
{
    ...
    /**
     * If connection object is needed to use this method and get access to it.
